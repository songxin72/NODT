...
hidden_dim_dic.update({"energy": 260})  # default: 125 var_num=26
hidden_dim_dic.update({"nasdaq": 820})  # var_num=82
hidden_dim_dic.update({"sml": 14})
hidden_dim_dic.update({"pm25": 70})  # var_num=7
hidden_dim_dic.update({"elec": 320})  # var_num=16
